...
import { sfProducts } from '../data/productsData';

const SFWatchesPage = () => {
  const [sortBy, setSortBy] = useState('popularity');
  const [products] = useState(sfProducts);
    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <nav className="text-sm text-gray-600 mb-2">
          ...
          <span className="text-gray-900 font-medium">SF Watches</span>
        </nav>
        <h1 className="text-2xl font-semibold text-gray-800">SF Watches Collection</h1>
      </div>
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url(https://www.sonatawatches.in/on/demandware.static/-/Library-Sites-SonataSharedLibrary/default/dw0f617132/images/Category%20Banners/ShopFor-PLP-SF.jpg)'
        }}
      >
        <div className="absolute inset-0 bg-black/30"></div>
        <h2 className="absolute inset-0 flex items-center justify-center text-white text-4xl md:text-6xl font-light tracking-wider">SF BY SONATA</h2>
      </div>
        ...
        <aside className="w-full lg:w-72 bg-white rounded-lg border p-5 h-fit sticky top-4">
          ...
          <div className="mb-6 pb-5 border-b border-gray-200">
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-sm"><input type="checkbox" className="mr-2" /> Men (354)</li>
              <li className="flex items-center text-sm"><input type="checkbox" className="mr-2" /> Women (210)</li>
              <li className="flex items-center text-sm"><input type="checkbox" className="mr-2" /> Unisex (45)</li>
            </ul>
          </div>
          ...
          <div className="mb-6 pb-5 border-b border-gray-200">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center text-sm"><input type="checkbox" className="mr-2" /> Stainless Steel (98)</li>
              <li className="flex items-center text-sm"><input type="checkbox" className="mr-2" /> Leather (45)</li>
              <li className="flex items-center text-sm"><input type="checkbox" className="mr-2" /> Silicone (12)</li>
            </ul>
            <a href="#" className="text-xs text-blue-600 font-semibold mt-2 inline-block">+8 More</a>
          </div>

          {/* Dial Color */}
          <div className="mb-6 pb-5 border-b border-gray-200">
            <h4 className="font-semibold mb-3 text-sm">Dial Color</h4>
            <ul className="space-y-2">
              <li className="flex items-center text-sm"><input type="checkbox" className="mr-2" /> Black (156)</li>
              <li className="flex items-center text-sm"><input type="checkbox" className="mr-2" /> Blue (89)</li>
              <li className="flex items-center text-sm"><input type="checkbox" className="mr-2" /> Silver (67)</li>
              <li className="flex items-center text-sm"><input type="checkbox" className="mr-2" /> Green (34)</li>
            </ul>
            <a href="#" className="text-xs text-blue-600 font-semibold mt-2 inline-block">+12 More</a>
          </div>

          {/* Function */}
          <div className="mb-6 pb-5 border-b border-gray-200">
            <h4 className="font-semibold mb-3 text-sm">Function</h4>
            <ul className="space-y-2">
              <li className="flex items-center text-sm"><input type="checkbox" className="mr-2" /> Analog (267)</li>
              <li className="flex items-center text-sm"><input type="checkbox" className="mr-2" /> Digital (156)</li>
              <li className="flex items-center text-sm"><input type="checkbox" className="mr-2" /> Ana-Digi (89)</li>
              <li className="flex items-center text-sm"><input type="checkbox" className="mr-2" /> Chronograph (45)</li>
            </ul>
          </div>
        </aside>
                  ...
                  <div className="p-2">
                    ...
                    {product.originalPrice && (
                      <div className="text-xs">
                        <span className="line-through text-gray-500 mr-1">₹ {product.originalPrice.toLocaleString()}</span>
